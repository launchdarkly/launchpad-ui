module.exports = {
	...
	// `csstools/value-no-unknown-custom-properties` reads the stylesheets `@launchpad-ui/tokens`
	// exports, so tokens must be built first (mirrors gonfalon's `stylelint` pre-commit hook). Uses the
