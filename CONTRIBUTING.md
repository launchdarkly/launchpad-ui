...
Do not add icons manually. Icons are autogenerated from the Figma icon library. To add new icons, make sure your new icon is merged to LaunchPad Figma library, then:

- Run `pnpm nx run @launchpad-ui/icons:sync` to build icons from Figma.
