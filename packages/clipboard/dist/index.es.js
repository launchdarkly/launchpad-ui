...
const CopyConfirmation = () => /* @__PURE__ */ jsxs("span", { className: styles["Clipboard-confirmation"], children: [
  /* @__PURE__ */ jsx(CheckCircle, { className: styles["Clipboard-checkmark"], size: "medium" }),
  /* @__PURE__ */ jsx("span", { className: styles["Clipboard-copied"], children: "Copied!" })
] });
const CopyToClipboard = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx("span", { className: classes, "data-test-id": testId, ...rest, children: /* @__PURE__ */ jsx(
      Tooltip,
      {
        ...tooltipOptions,
        isOpen,
