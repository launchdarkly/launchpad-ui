...
const SplitButtonDropdown = ({
  ...
  const { disabled: parentDisabled } = react.useContext(SplitButtonContext);
...
const SplitButtonDropdownButton = react.forwardRef(
  (props, ref) => {
    const {
      disabled,
      className,
    ...
    const { disabled: parentDisabled, kind, size } = react.useContext(SplitButtonContext);
    const isDisabled = parentDisabled || disabled;
...
const SplitButtonMainButton = react.forwardRef(
  (props, ref) => {
    const {
      disabled,
      children,
