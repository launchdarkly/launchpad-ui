...
import type { LaunchPadAfterburnProps } from '../src/types';

import { Button, Heading, Text } from '@launchpad-ui/components';

import { LaunchPadAfterburn } from '../src';

const meta: Meta<typeof LaunchPadAfterburn> = {
	title: 'Tools/LaunchPad Afterburn',
	component: LaunchPadAfterburn,
	parameters: {
		layout: 'fullscreen',
		docs: {
			description: {
	...
	argTypes: {
		...
		enabled: {
			control: 'boolean',
			description: 'Whether Afterburn is enabled',
		},
	},
};
...
// Sample page with LaunchPad components to test Afterburn
const SamplePage = () => (
	<div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
		<Heading level={1}>LaunchPad Afterburn Demo</Heading>
...
export const Default: Story = {
	...
	render: (args: LaunchPadAfterburnProps) => (
		<>
			<SamplePage />
			<LaunchPadAfterburn {...args} />
		</>
	),
};
...
export const Disabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: 'Afterburn is disabled and will not respond to keyboard shortcuts or double-clicks.',
			},
		},
	},
};
