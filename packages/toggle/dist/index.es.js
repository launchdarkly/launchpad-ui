...
const Toggle = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: classes, children: [
    ...
    /* @__PURE__ */ jsxs("label", { className: styles["Toggle-wrapper"], htmlFor: id, children: [
      /* @__PURE__ */ jsx(VisuallyHidden, { children: /* @__PURE__ */ jsx("div", { children }) }),
      /* @__PURE__ */ jsxs("div", { className: styles["Toggle-labels"], "aria-hidden": true, children: [
        /* @__PURE__ */ jsx("div", { className: cx(styles["Toggle-label"], styles["Toggle-on"]), children: toggleOnText }),
        /* @__PURE__ */ jsx("div", { className: cx(styles["Toggle-label"], styles["Toggle-off"]), children: toggleOffText })
      ] }),
      /* @__PURE__ */ jsx("div", { className: styles["Toggle-pin"] })
    ] })
  ] });
};
export {
