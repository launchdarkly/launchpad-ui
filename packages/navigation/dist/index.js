...
const Nav = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(NavBase, {
  ...props,
  innerRef: ref
}));
Nav.displayName = "Nav";
...
const NavItem = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.NavLink, {
    ...
    className: ({
      isActive
    }) => classix.cx(styles.NavItem, isActive && styles["is-active"]),
    "data-text": name,
    onClick,
    role,
    ...
    children: status ? /* @__PURE__ */ jsxRuntime.jsxs("div", {
      style: {
        display: "flex",
        alignItems: "flex-end"
      },
      children: [/* @__PURE__ */ jsxRuntime.jsx("span", {
        ...
        children: name
      }), /* @__PURE__ */ jsxRuntime.jsx(chip.Chip, {
...
const defaultContent = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
  children: ["Upgrade your plan to use this feature.", /* @__PURE__ */ jsxRuntime.jsx("br", {}), "Click to learn more."]
});
const NavItemWithTooltip = ({
  ...
  const centeredContent = /* @__PURE__ */ jsxRuntime.jsx("div", {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(tooltip.Tooltip, {
    ...
    "data-test-id": testId,
    children: /* @__PURE__ */ jsxRuntime.jsx(NavItem, {
      end,
      to,
      name,
      onClick,
...
const NavigationMenuDropdown = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(dropdown.Dropdown, {
    children: [/* @__PURE__ */ jsxRuntime.jsx(dropdown.DropdownButton, {
      "data-test-id": "navigation-menu-button",
      children: props.title
    }), /* @__PURE__ */ jsxRuntime.jsx(menu.Menu, {
      children: [...state.collection].map((item) => /* @__PURE__ */ jsxRuntime.jsx(menu.MenuItem, {
        item: item.key,
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("div", {
          ...
          }), item.props.status ? /* @__PURE__ */ jsxRuntime.jsx("div", {
            children: /* @__PURE__ */ jsxRuntime.jsx(chip.Chip, {
...
const NavigationList = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", {
    ...
    ref: refs.wrapperRef,
    children: shouldCollapse ? /* @__PURE__ */ jsxRuntime.jsx(NavigationMenuDropdown, {
      title,
      "aria-label": title,
      ...rest
      ...
      children: [...state.collection].map((item) => item.props.tooltip ? /* @__PURE__ */ jsxRuntime.jsx(NavItemWithTooltip, {
        to: item.props.to,
        id: item.props.id,
      ...
      }, item.key) : /* @__PURE__ */ jsxRuntime.jsx(NavItem, {
        to: item.props.to,
        id: item.props.id,
        name: item.props.name,
...
const Navigation = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", {
    className: classix.cx(styles.Navigation, shouldCollapse && styles["Navigation--collapsed"], className),
    "data-test-id": testId,
    children: /* @__PURE__ */ jsxRuntime.jsx(NavigationContext.Provider, {
      value: {
        shouldCollapse,
        refs: {
          wrapperRef,
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(NavigationList, {
        ...props
      })
    })
  });
