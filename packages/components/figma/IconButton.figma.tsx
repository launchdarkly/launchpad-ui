...
figma.connect(IconButton, 'https://www.figma.com/design/98HKKXL2dTle29ikJ3tzk7/LaunchPad?node-id=1-28835', {
	props: {
	...
	example: ({ icon, variant, size, isDisabled }) => (
		<IconButton aria-label="label" icon={icon.name} variant={variant} size={size} isDisabled={isDisabled} />
	),
});
