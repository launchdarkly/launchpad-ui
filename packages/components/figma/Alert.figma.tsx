...
figma.connect(Alert, 'https://www.figma.com/design/98HKKXL2dTle29ikJ3tzk7/%F0%9F%9A%80-LaunchPad?node-id=8003%3A631', {
	props: {
...
figma.connect(Alert, 'https://www.figma.com/design/98HKKXL2dTle29ikJ3tzk7/%F0%9F%9A%80-LaunchPad?node-id=8003%3A631', {
	...
	example: (props) => (
		<Alert isDismissable={props.isDismissable} status={props.status} variant={props.variant} onDismiss={() => {}}>
			<Text>{props.messageText}</Text>
		</Alert>
	),
});
