...
const Snackbar = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      role: "status",
      children: [
        /* @__PURE__ */ jsx(StatusIcon, { kind, className: styles$1["Snackbar-icon"] }),
        /* @__PURE__ */ jsxs("div", { className: styles$1["Snackbar-content"], children: [
          header && /* @__PURE__ */ jsx("h4", { className: styles$1["Snackbar-heading"], children: header }),
          /* @__PURE__ */ jsx("span", { className: styles$1["Snackbar-description"], children: description }),
          " ",
          CTA
        ] }),
        /* @__PURE__ */ jsx(
...
const SnackbarCenter = ({ snackbars, dismissSnackbar, className }) => {
  ...
  return /* @__PURE__ */ jsx(LazyMotion, { strict: true, features: loadFeatures, children: /* @__PURE__ */ jsx("div", { className: classes, children: /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: snackbars.map((item) => /* @__PURE__ */ jsx(
    m.div,
    {
