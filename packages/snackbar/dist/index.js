...
const Snackbar = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      role: "status",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(icons.StatusIcon, { kind, className: styles$1["Snackbar-icon"] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: styles$1["Snackbar-content"], children: [
          header && /* @__PURE__ */ jsxRuntime.jsx("h4", { className: styles$1["Snackbar-heading"], children: header }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: styles$1["Snackbar-description"], children: description }),
          " ",
          CTA
        ] }),
...
const SnackbarCenter = ({ snackbars, dismissSnackbar, className }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(framerMotion.LazyMotion, { strict: true, features: loadFeatures, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: classes, children: /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { initial: false, children: snackbars.map((item) => /* @__PURE__ */ jsxRuntime.jsx(
    framerMotion.m.div,
    {
