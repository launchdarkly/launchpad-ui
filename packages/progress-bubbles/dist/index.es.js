...
const ProgressBubbles = ({
  ...
  if (items && items.length) {
    children = items.map((item, idx) => {
      ...
      const bubble = /* @__PURE__ */ jsxs("div", {
        className: cx(styles["ProgressBubbles-icon"], hasMultipleIcons && styles["ProgressBubbles-icon--multiple"], idx === currentBubble && styles["ProgressBubbles-icon--current"], idx > currentBubble && styles["ProgressBubbles-icon--pending"], item.isWarning && styles["ProgressBubbles-icon--warning"]),
        style: {
          width: `${iconWidth}rem`
        },
        children: [item.icons, /* @__PURE__ */ jsx("label", {
      ...
      return /* @__PURE__ */ jsxs(Fragment, {
        children: [!!idx && /* @__PURE__ */ jsx("div", {
          className: cx(styles["ProgressBubblesUsingItems-line"], idx <= currentBubble && styles["ProgressBubblesUsingItems-line--completed"])
        }), /* @__PURE__ */ jsx("div", {
          className: styles["ProgressBubblesIconContainer"],
          children: item.popover ? /* @__PURE__ */ jsxs(Popover, {
    ...
    for (let i = 0; i < numBubbles; i++) {
      children.push(/* @__PURE__ */ jsxs(Fragment, {
        children: [!!i && /* @__PURE__ */ jsx("div", {
          className: cx(styles["ProgressBubbles-line"], i <= currentBubble && styles["ProgressBubbles--filled"])
        }), /* @__PURE__ */ jsx("div", {
          className: cx(styles["ProgressBubbles-bubble"], i <= currentBubble && styles["ProgressBubbles--filled"], i === 0 && styles["ProgressBubbles-bubble--first"], i === numBubbles - 1 && styles["ProgressBubbles-bubble--last"]),
  ...
  return /* @__PURE__ */ jsx("div", {
    className: cx(styles.ProgressBubbles, className, vertical && styles["ProgressBubbles--vertical"]),
    ref,
    "data-test-id": testId,
    children
  });
