  ...
  if (items && items.length) {
    children = items.map((item, idx) => {
      ...
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: styles["ProgressBubblesIconContainer"], children: item.popover ? /* @__PURE__ */ jsxs(
          Popover,
          {
            ...
            target: item.icons,
            children: [
              /* @__PURE__ */ jsx("div", { role: "button", tabIndex: 0, children: bubble }),
              item.popover
            ]
          }
        ) : bubble })
        ...
        /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("span", { className: styles["ProgressBubbles-text"], children: !!bubbleLabels && (showCurrentLabelOnly ? i === currentBubble && bubbleLabels[currentBubble] : bubbleLabels[i]) })
            }
          )
        ] }, i)
      );
