...
import { UnfoldMore } from '@launchpad-ui/icons';
...
const Picker = <T extends object>(props: AriaSelectProps<T>) => {
  ...
  return (
    <div className="inline-flex flex-col relative w-52 mt-4">
      ...
      >
        ...
        <UnfoldMore className={`w-5 h-5 ${isFocusVisible ? 'text-pink-500' : 'text-gray-500'}`} />
      </button>
      {state.isOpen && (
